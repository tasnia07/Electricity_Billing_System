...
public class GenerateBillController implements Initializable {
    ...
    public  double Calculation(double mnth)
    {
        double PresentMonthCost=0.0;
     if(mnth<=200){
                PresentMonthCost = mnth*5.72; 
                return PresentMonthCost;
            }
            else{
                PresentMonthCost = mnth*9.94;
                return PresentMonthCost;
            }     
    }
    ...
    private void GenerateBill(ActionEvent event) {
        ...
        try {
            ...
            double PresentMonthCost=Calculation(month);
           
            tax = PresentMonthCost + 30;
